  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold mb-8 tracking-tight">Admin Controls</h1>
        ...
        <Card className="p-6">
          <Card.Header className="px-0 pt-0">
            <div>
              ...
              <Card.Description>
                Fetch instruments from NSE and bulk download historical candles since 2000.
              </Card.Description>
            </div>
          </Card.Header>
                ...
                {status.stats && (
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6 text-center">
                    <div className="p-4 bg-surface/50 rounded-xl border border-border">
                      ...
                      <div className="text-xs text-muted uppercase tracking-wider mt-1">Total</div>
                    </div>
                    <div className="p-4 bg-surface/50 rounded-xl border border-border">
                      <div className="text-2xl font-bold text-success">{status.stats.fetched}</div>
                      <div className="text-xs text-muted uppercase tracking-wider mt-1">Fetched</div>
                    </div>
                    <div className="p-4 bg-surface/50 rounded-xl border border-border">
                      <div className="text-2xl font-bold text-accent">{status.stats.skipped}</div>
                      <div className="text-xs text-muted uppercase tracking-wider mt-1">Cached</div>
                    </div>
                    <div className="p-4 bg-surface/50 rounded-xl border border-border">
                      <div className="text-2xl font-bold text-danger">{status.stats.failed}</div>
                      <div className="text-xs text-muted uppercase tracking-wider mt-1">Failed</div>
                    </div>
                  </div>
                )}
              </div>
