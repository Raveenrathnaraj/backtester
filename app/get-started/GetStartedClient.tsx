...
const cards = [
  {
    ...
    description: 'Run backtests with your strategies against 20+ years of historical NSE data. View equity curves, trade logs, win rates, and risk metrics.',
  ...
  },
  {
    ...
    description: 'Describe a trading strategy in plain English. Our Gemini AI will ask the right questions and generate executable backtesting code for you.',
  ...
  },
  {
    ...
    description: 'Build custom watchlists from NSE indices — Nifty 50, Nifty 500, sectoral indices, or hand-pick individual stocks for targeted backtesting.',
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {cards.map((card, i) => (
            ...
            >
              ...
              {/* Icon */}
              <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${card.gradient} flex items-center justify-center text-white mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                {card.icon}
              </div>
