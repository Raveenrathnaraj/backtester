      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-muted mt-1.5">
            Manage your custom AI-generated stock trading strategies and
            backtesting rules
          </p>
        </div>
        <Button
      ...
      {strategies.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 rounded-2xl border border-dashed border-border bg-card/20 text-center">
          ...
          <p className="text-sm text-muted max-w-sm mt-1 mb-6">
            You don't have any custom trading strategies yet. Let the AI help
            you build one!
          </p>
          <Button
            variant="secondary"
            ...
            >
              ...
              <div className="flex items-center gap-2 pt-4 border-t border-border/40">
                ...
                <Button
                  ...
                  size="sm"
                  onPress={() =>
                    router.push(`/dashboard?strategyId=${strategy.id}`)
                  }
